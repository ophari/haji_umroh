...
<body>
    ...
    <div class="hContainer">
        <div class="sosmed">
            <div class="wa">
              <img src="../img/whatsapp-logo.png" alt="logo WA">
              <p>+62 0837-4985-2013</p>
            </div>
            <div class="ig">
              <img src="../img/instagram-icon.png" alt="logo IG">
              <p>@Itkontamatravel.id</p>
            </div>
            <div class="fb">
              <img src="../img/facebook-logo.png" alt="logo FB">
              <p>itkontamatravel.id</p>
            </div>
          </div>
        <nav class="sidebar">
