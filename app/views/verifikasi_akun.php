...
<body>
    ...
    <div class="hContainer">
            <div>
                <h1 class="verifikasi">AKUN ANDA TELAH TERVERIFIKASI</h1>
                <img class="img-verify"src="./asset/LogoItkontamaTravelOrange2022.png" alt="Logo Itkon">
            </div>
        <nav class="sidebar">
            <img class="user-logo" src="./asset/icon-user.png" alt="user-logo" href="index.html">
            <ul class="nav-list">
